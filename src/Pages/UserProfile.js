...
const UserProfile = () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                const artworkResponse = await fetch(
                    `https://demo-project-backend-5u11.onrender.com/api/users/${data.id}/artworks`,
                    {
                        method: "GET",
                        headers: {
                            Authorization: `Bearer ${localStorage.getItem("access_token")}`,
    ...
    const fetchLikedArtworks = async () => {
        try {
            const response = await fetch("https://demo-project-backend-5u11.onrender.com/api/users/me/liked-artworks", {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("access_token")}`,
                },
    ...
    const fetchUserContacts = async () => {
        try {
            const response = await fetch("https://demo-project-backend-5u11.onrender.com/api/users/me/contacts", {
                method: "GET",
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("access_token")}`,
                },
    ...
    const handleSave = async () => {
        try {
            ...
            const response = await fetch(`https://demo-project-backend-5u11.onrender.com/api/users/${currentUserId}`, {
                method: "PUT",
                headers: {
                    Authorization: `Bearer ${localStorage.getItem("access_token")}`,
                },
