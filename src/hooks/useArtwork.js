...
const useArtwork = () => {
  ...
  const fetchArtworks = useCallback(async (style) => {
    ...
    try {
      const response = await axios.get(
        `https://demo-project-backend-jj40.onrender.com/api/artworks/${style}`,
        {
  ...
  const likeArtwork = async (artworkId) => {
    ...
    try {
      const response = await axios.post(
        `https://demo-project-backend-jj40.onrender.com/api/artworks/${artworkId}/like`,
        {},
        {
          headers: { Authorization: `Bearer ${token}` },
        }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        "https://demo-project-backend-jj40.onrender.com/api/artworks/submit",
        data,
        {
          headers: { Authorization: `Bearer ${token}` },
